	...
	\section{Réalisation de Nono-1}
		...
		\subsection{Opcode des instructions}
			...
			\begin{tabular}{|p{4cm}|c|c|c|c|}
				...
				\end{tabular}
			\label{tab_opcode}
			\caption{\textit{Opcode} des différentes instruction du processeur \textsc{Nono 1}}
			\end{figure}
			...
			arithmétique et logique du processeur, on s'apperçoit qu'ils peuvent être divisé 
			...
			aux sauts. Enfin le dernier groupe est composé des autres instructions. Sitons
